...
/*  for (int i=0;i<7;i++) {
  for (int j=0;j<6;j++) {
    if (b->cells[i][j] == X && b->cells[i][j+1] == X && b->cells[i][j+2] == X && b->cells[i][j+3] == X) return true;
    else if (b->cells[i][j] == O && b->cells[i][j+1] == O && b->cells[i][j+2] == O && b->cells[i][j+3] == O) return true;
    else if (b->cells[i][j] == X && b->cells[i+1][j] == X && b->cells[i+2][j] == X && b->cells[i+3][j] == X) return true;
    else if (b->cells[i][j] == O && b->cells[i+1][j] == O && b->cells[i+2][j] == O && b->cells[i+3][j] == O) return true;
  }
  }
  return false;
}*/
